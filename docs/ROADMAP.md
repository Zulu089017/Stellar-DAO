...
| Audit logging         |   ✅   | Structured audit log for all mutating requests |
...
- [x] Invoice dashboard (web) — create, view, pay invoices
- [x] Wallet management expansion (xBull)
- [x] Audit logging middleware with structured JSON output
